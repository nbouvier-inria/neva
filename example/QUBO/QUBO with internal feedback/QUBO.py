...
if __name__ == "__main__":
    ...
    Q = np.array([[0, 5, 0, -3, 7],
                ...
                [7, 0, 0, 0, 0]], dtype=int)
    '''
    Q: np.ndarray = sparse_to_array('gka_sparse_all/gka4e.sparse')
    ...
    print("The SNN converges towards", QUBO_Value(Q,x))
    print("An annealing equivalent finds a value of", QUBO_annealing(Q=Q, n=num_steps, temperature=lambda x:x) )
